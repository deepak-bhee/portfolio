    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group w-full">
        ...
        >
          ...
          >
            {/* Shine */}
            {showShine && <div style={shineStyle} />}
            {/* Glare */}
            {showShine && <div style={glareStyle} />}

            {/* Avatar */}
            <div
              style={{ mixBlendMode: 'normal', transform: 'translateZ(2px)', gridArea: '1 / -1', borderRadius: cardRadius, pointerEvents: 'none', overflow: 'visible' }}
            >
              <img
                ...
                style={{
                  ...
                  filter: 'grayscale(1)',
                  transform: 'translate3d(calc((var(--pointer-from-left) - 0.5) * 6px), calc((var(--pointer-from-top) - 0.5) * 6px), 0) scaleY(calc(1 + (var(--pointer-from-top) - 0.5) * 0.02)) scaleX(calc(1 + (var(--pointer-from-left) - 0.5) * 0.01))',
                }}
